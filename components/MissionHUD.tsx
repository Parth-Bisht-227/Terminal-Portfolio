  ...
  return (
    <div className="p-4 bg-slate-100/60 dark:bg-black/40 border border-cyber-darkPurple/20 dark:border-cyber-purple/30 rounded-xl mt-4 max-w-2xl shadow-inner">
      <div className="flex items-center gap-3 mb-6">
        ...
        <div>
          <h2 className="text-lg font-bold tracking-tight text-cyber-darkPurple dark:text-cyber-purple shimmer uppercase">MISSION: US STARTUP 2026</h2>
          <p className="text-[10px] uppercase font-bold text-slate-400 dark:text-white/50 tracking-wider">FOUNDING ENGINEER TRACK</p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <div className="space-y-4">
          ...
          <ul className="space-y-3">
            {[
              { label: 'Voice AI Systems (Production-grade)', status: 'OK', color: '#16a34a', darkColor: '#39FF14' },
              { label: 'LLM Agents & Function Calling', status: 'OK', color: '#16a34a', darkColor: '#39FF14' },
              { label: 'Agentic Frameworks & RAG', status: 'RUN', color: '#d97706', darkColor: '#FFB100' },
              { label: 'System Design & Scalability', status: 'RUN', color: '#d97706', darkColor: '#FFB100' },
              { label: 'Deep Learning Foundations', status: 'PEND', color: '#7c3aed', darkColor: '#BC13FE' }
            ].map((m, i) => (
      ...
      <div className="mt-8 pt-6 border-t border-black/5 dark:border-white/10 flex flex-col md:flex-row items-center justify-between gap-4">
        <div className="flex items-center gap-2 text-[10px] text-slate-500 dark:text-white/40 font-medium italic">
          ...
          Target: Early-stage US Startup, Remote/Hybrid
        </div>
        <div className="px-5 py-2 border border-cyber-darkPurple/50 dark:border-cyber-purple/50 bg-cyber-darkPurple/5 dark:bg-cyber-purple/10 text-[10px] font-bold tracking-widest text-cyber-darkPurple dark:text-cyber-purple rounded-full animate-pulse flex items-center gap-2 whitespace-nowrap shadow-sm">
          <Plane size={14} /> STATUS: ACTIVELY_BUILDING
        </div>
      </div>
    </div>
  );
